...
SRC_URI = "file://sample.js \
           ...
           file://COPYING.MIT \
           file://manifest \
           file://test-node3.service \
"

OSTRO_USER_NAME = "test"
OSTRO_APP_NAME  = "node3"
...
do_install () {
    ...
    install -d ${D}${OSTRO_APP_ROOT}/etc/systemd/system
    install -m 0644 test-node3.service \
        ${D}${OSTRO_APP_ROOT}/etc/systemd/system
}
