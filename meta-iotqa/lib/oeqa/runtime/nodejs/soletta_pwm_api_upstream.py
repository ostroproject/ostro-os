...
@tag(TestType='FVT', FeatureID='IOTOS-1156')
class solettaPWMApiTest(TestCaseInterface):
    '''
    @class solettaPWMApiTest
    ...
    def test_sol_pwm_api(self):
        ...
        '''
        sys.stdout.write(
            '\nExecuting soletta pwm upstream test cases...'
            )
        sys.stdout.flush()
        run_grunt_cmd = ''.join([
            'cd ',
