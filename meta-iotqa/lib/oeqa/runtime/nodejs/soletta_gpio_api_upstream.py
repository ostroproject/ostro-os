...
@tag(TestType='FVT', FeatureID='IOTOS-1152')
class solettaGPIOApiTest(TestCaseInterface):
    '''
    @class solettaGPIOApiTest
    ...
    def test_sol_gpio_api(self):
        ...
        '''
        sys.stdout.write(
            '\nExecuting soletta gpio upstream test cases...'
            )
        sys.stdout.flush()
        run_grunt_cmd = ''.join([
            'cd ',
