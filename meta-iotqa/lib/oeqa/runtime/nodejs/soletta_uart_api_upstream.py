...
@tag(TestType='FVT', FeatureID='IOTOS-1154')
class solettaUARTApiTest(TestCaseInterface):
    '''
    @class solettaUARTApiTest
    ...
    def test_sol_uart_api(self):
        ...
        '''
        sys.stdout.write(
            '\nExecuting soletta uart upstream test cases...'
            )
        sys.stdout.flush()
        run_grunt_cmd = ''.join([
            'cd ',
