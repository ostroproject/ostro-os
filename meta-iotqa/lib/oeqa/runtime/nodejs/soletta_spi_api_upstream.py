...
@tag(TestType='FVT', FeatureID='IOTOS-1153')
class solettaSPIpiTest(TestCaseInterface):
    '''
    @class solettaSPIpiTest
    ...
    def test_sol_spi_api(self):
        ...
        '''
        sys.stdout.write(
            '\nExecuting soletta spi upstream test cases...'
            )
        sys.stdout.flush()
        run_grunt_cmd = ''.join([
            'cd ',
