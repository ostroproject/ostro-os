...
python do_test_iot_export() {
    ...
    exportbitbakelib = os.path.join(exportdir, "bitbake", "lib")
    bb.utils.mkdirhier(exportbitbakelib)
    recursive_overwrite(os.path.join(d.getVar("TOPDIR", True), "..", "bitbake", "lib"), exportbitbakelib)
